...
import my.android.linkup.Utils.CommentListAdapter;
...
public class ViewComments extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        DatabaseReference databaseReference = FirebaseDatabase.getInstance("https://link-up-b90a9-default-rtdb.firebaseio.com/").getReference("Users").child(userid);
...
//        Log.d(TAG, "getPhotoFromBundle: arguments: " + bundle.getParcelable("Photo"));
    ...
    private void getCommentList(){
        ...
        mFirebaseDatabase = FirebaseDatabase.getInstance("https://link-up-b90a9-default-rtdb.firebaseio.com/");
