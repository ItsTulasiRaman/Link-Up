package my.android.linkup.Messages.Adapter;
...
import my.android.linkup.Messages.MessageActivity;
...
//        holder.fullname.setText(users.getFullName());
    ...
    private void lastMessage(final String userid, final TextView last_msg){
        ...
        DatabaseReference reference = FirebaseDatabase.getInstance("https://link-up-b90a9-default-rtdb.firebaseio.com/").getReference("Chats");
