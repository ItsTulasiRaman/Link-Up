package my.android.linkup.Post;
...
import my.android.linkup.Home;
import my.android.linkup.R;
import my.android.linkup.Utils.methods;
...
public class PostActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        databaseReference = FirebaseDatabase.getInstance("https://link-up-b90a9-default-rtdb.firebaseio.com/").getReference();
...
//******************************FUNCTION TO INCREASE POST COUNT********
    public void increasePostCount(final int count){
        ...
        data = FirebaseDatabase.getInstance("https://link-up-b90a9-default-rtdb.firebaseio.com/").getReference("Users").child(userId);
