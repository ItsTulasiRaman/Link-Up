...
import my.android.linkup.Profile.FollowersFollowing;
import my.android.linkup.R;
import my.android.linkup.Utils.GridImageAdapter;
import my.android.linkup.models.Comments;
...
//        isFollowing();
        ...
        Follow.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                FirebaseDatabase.getInstance("https://link-up-b90a9-default-rtdb.firebaseio.com/").getReference()
                        .child("Following")
...
//             Other User
    ...
    private void dataretrive(){
        ...
        databaseReference = FirebaseDatabase.getInstance("https://link-up-b90a9-default-rtdb.firebaseio.com/").getReference("Users").child(searchedUserId);
...
//                setup our image grid
    ...
    public void increaseFollowing(){
        ...
        final DatabaseReference data = FirebaseDatabase.getInstance("https://link-up-b90a9-default-rtdb.firebaseio.com/").getReference("Users")
                .child(FirebaseAuth.getInstance().getCurrentUser().getUid());
