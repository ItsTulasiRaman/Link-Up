...
import my.android.linkup.models.Notification;
...
//                mcontext.startActivity(intent);
    ...
    private void getPostImage(final ImageView postimg, String postid){
        ...
        final DatabaseReference reference = FirebaseDatabase.getInstance("https://link-up-b90a9-default-rtdb.firebaseio.com/").getReference("Photo")
                .child(postid);
